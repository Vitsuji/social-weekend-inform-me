...
class CrudController {
    constructor(service) {
        ...
        this.routes = {
            ...
            '/create': [{method: 'put', cb: this.create}],
    ...
    //     const read = await this.service.readChunk(req.query);
    //     this.cacheService.set(req, read);
    //     res.json(read);
    // }

    async read(req, res) {
        const read = await this.service.read(req.params.id);
        this.cacheService.set(req, read);
        res.json(read);
    }
